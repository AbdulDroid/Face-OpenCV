...
extern "C" {
JNIEXPORT void JNICALL Java_com_example_android_face_ModelView_FindFeatures(JNIEnv* env, jobject, jint width, jint height, jbyteArray yuv, jintArray bgra)
{
	try {
...
JNIEXPORT void JNICALL Java_com_example_android_face_ModelView_FindFaces(JNIEnv* env, jobject, jstring jImageName,jstring jFileName)
{
	try {
...
JNIEXPORT int JNICALL Java_com_example_android_face_ModelView_Find(JNIEnv* env, jobject, jstring jImageName,jstring jFileName,jstring jCsv)
{
	try {
