...
Java_com_kafilicious_opencv_ModelView_FindFeatures(JNIEnv* env, jobject, jint width, jint height, jbyteArray yuv, jintArray bgra)
{
    try {
...
JNIEXPORT void JNICALL
Java_com_kafilicious_opencv_ModelView_FindFaces(JNIEnv* env, jobject, jstring jImageName,jstring jFileName)
{
    try {
...
Java_com_kafilicious_opencv_ModelView_Find(JNIEnv* env, jobject, jstring jImageName,jstring jFileName,jstring jCsv)
{
    try {
...
Java_com_kafilicious_opencv_FaceActivity_stringFromJNI(
        JNIEnv *env,
        jobject /* this */) {
